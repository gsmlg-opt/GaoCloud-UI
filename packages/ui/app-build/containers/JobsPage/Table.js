...
import { makeSelectJobsList } from '../../../app/ducks/jobs/selectors';
...
const JobsTable = ({ location, data, clusterID, namespaceID, removeJob }) => {
...
export default compose(withConnect)(JobsTable);
