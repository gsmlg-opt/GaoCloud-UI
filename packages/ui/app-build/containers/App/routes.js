...
import LibraryBooks from '@mui/icons-material/LibraryBooks.js';
import BubbleChart from '@mui/icons-material/BubbleChart.js';
import LocationOn from '@mui/icons-material/LocationOn.js';
import Notifications from '@mui/icons-material/Notifications.js';
import Unarchive from '@mui/icons-material/Unarchive.js';
import Language from '@mui/icons-material/Language.js';

import NotFoundPage from '../../../app/containers/NotFoundPage/Loadable';
import ClustersPage, {
  CreateClusterPage,
  ClusterManagePage,
} from '../../../app/containers/ClustersPage/Loadable';
import ClusterDetailPage, {
  ClusterThresholdsPage,
} from '../../../app/containers/ClusterDetailPage/Loadable';
import NodesPage, { NodeDetailPage } from '../../../app/containers/NodesPage/Loadable';
import NamespacesPage, {
  CreateNamespacePage,
  NamespaceDetailPage,
  NamespaceOverviewPage,
  NamespaceThresholdsPage,
} from '../../../app/containers/NamespacesPage/Loadable';
import EventsPage from '../../../app/containers/EventsPage/Loadable';
import HPAPage, {
  CreateHPAPage,
  ShowHPAPage,
  UpdateHPAPage,
} from '../../../app/containers/HPAPage/Loadable';
import DeploymentsPage, {
  CreateDeploymentPage,
  DeploymentDetailPage,
  UpdateDeploymentPage,
} from '../../../app/containers/DeploymentsPage/Loadable';
import StatefulSetsPage, {
  CreateStatefulSetPage,
  StatefulSetDetailPage,
  UpdateStatefulSetPage,
} from '../../../app/containers/StatefulSetsPage/Loadable';
import DaemonSetsPage, {
  CreateDaemonSetPage,
  DaemonSetDetailPage,
  UpdateDaemonSetPage,
} from '../../../app/containers/DaemonSetsPage/Loadable';
import CronJobsPage, {
  CreateCronJobPage,
  CronJobDetailPage,
} from '../../../app/containers/CronJobsPage/Loadable';
import JobsPage, {
  CreateJobPage,
  JobDetailPage,
} from '../../../app/containers/JobsPage/Loadable';
import PersistentVolumeClaimsPage from '../../../app/containers/PersistentVolumeClaimsPage/Loadable';
import ConfigMapsPage, {
  CreateConfigMapPage,
  ShowConfigMapPage,
  EditConfigMapPage,
} from '../../../app/containers/ConfigMapsPage/Loadable';
import SecretsPage, {
  CreateSecretPage,
  ShowSecretPage,
  EditSecretPage,
} from '../../../app/containers/SecretsPage/Loadable';
import ServicesPage, {
  CreateServicePage,
  ShowServicePage,
} from '../../../app/containers/ServicesPage/Loadable';
import SvcMeshWorkloadsPage, {
  ShowSvcMeshWorkloadPage,
} from '../../../app/containers/SvcMeshWorkloadsPage/Loadable';
import SvcMeshPodsPage from '../../../app/containers/SvcMeshPodsPage/Loadable';
import SvcMeshTapPage from '../../../app/containers/SvcMeshTapPage/Loadable';
import IngressesPage, {
  CreateIngressPage,
  ShowIngressPage,
} from '../../../app/containers/IngressesPage/Loadable';
import UdpIngressesPage, {
  CreateUdpIngressPage,
  ShowUdpIngressPage,
} from '../../../app/containers/UdpIngressesPage/Loadable';
import ServiceLinkPage from '../../../app/containers/ServiceLinkPage/Loadable';
import StoragesPage, {
  CreateStoragePage,
  EditStoragePage,
  StorageDetailPage,
} from '../../../app/containers/StoragesPage/Loadable';
import NetworkPage from '../../../app/containers/NetworkPage/Loadable';
import UserQuotasPage, {
  ...
  AdminUserQuotaPage,
  EditUserQuotaPage,
} from '../../../app/containers/UserQuotasPage/Loadable';
import ApplicationStorePage from '../../../app/containers/ApplicationStorePage/Loadable';
import ApplicationsPage, {
  ApplicationDetailPage,
  CreateApplicationPage,
} from '../../../app/containers/ApplicationsPage/Loadable';
import UsersPage, {
  CreateUserPage,
  EditUserPage,
  UserProfilePage,
  PasswordSetupPage,
} from '../../../app/containers/UsersPage/Loadable';
import AlarmMessagesPage from '../../../app/containers/AlarmMessagesPage';
import GlobalConfigurationPage from '../../../app/containers/GlobalConfigurationPage';
import AuditLogsPage from '../../../app/containers/AuditLogsPage/Loadable';
import WorkFlowPage, {
  CreateWorkFlowPage,
  ShowWorkFlowPage,
  UpdateWorkFlowPage,
  LogsPage,
} from '../../../app/containers/WorkFlowsPage/Loadable';
