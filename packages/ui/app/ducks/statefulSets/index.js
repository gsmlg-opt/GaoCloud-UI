...
export const reducer = (
  ...
  switch (type) {
    ...
    case c.LOAD_STATEFUL_SETS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.LOAD_STATEFUL_SETS_FAILURE))
        .setIn([
          'data',
          clusterID,
          namespaceID,
    ...
    case c.CREATE_STATEFUL_SET_SUCCESS: {
      ...
      return state.setIn([
        ...
        .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.CREATE_STATEFUL_SET_FAILURE));
    }
    ...
    case c.UPDATE_STATEFUL_SET_SUCCESS: {
      ...
      if (id) {
        return state.setIn([
          ...
          .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.UPDATE_STATEFUL_SET_FAILURE));
      }
      return state;
    }
    ...
    case c.READ_STATEFUL_SET_SUCCESS: {
      ...
      if (id) {
        return state.setIn([
          ...
          .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.READ_STATEFUL_SET_FAILURE));
      }
      return state;
    }
    ...
    case c.REMOVE_STATEFUL_SET_SUCCESS: {
      ...
      if (status === 202) {
        return state.update('errorsList', (errors) => errors.filterNot((e) => e.type === c.REMOVE_STATEFUL_SET_FAILURE));
      }
      return state
        .removeIn([
          'data',
        ...
        .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.REMOVE_STATEFUL_SET_FAILURE));
    }
    ...
    case c.EXECUTE_STATEFUL_SET_ACTION_SUCCESS:
      if (meta.patch === true) {
        ...
        return state.mergeDeepIn([
          ...
          .update('errorsList', (errors) => errors.filterNot((e) => e.type === c.EXECUTE_STATEFUL_SET_ACTION_FAILURE));
      }
      return state.update('errorsList', (errors) => errors.filterNot((e) => e.type === c.EXECUTE_STATEFUL_SET_ACTION_FAILURE));
